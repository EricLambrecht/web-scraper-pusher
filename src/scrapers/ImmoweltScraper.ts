...
export default class ImmoweltScraper extends ListChangeScraper {
    ...
    startUrl = "https://www.immowelt.de/liste/suchauftragsergebnisse/ca7cf7c23fa64ea686897bd03b26b169"
    ...
    async handleCookieBanner() {
        try {
            const cookieBanner = await this.page.waitForSelector('[data-testid=uc-tcf-first-layer]', { timeout: 5000 })
            if (cookieBanner) {
